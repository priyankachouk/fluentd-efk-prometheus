...
```
kubectl apply -f .\kubernetes\counter.yaml
kubectl get pods
...
kubectl -n elastic-kibana apply -f .\kubernetes\elastic\elastic-demo.yaml
kubectl -n elastic-kibana get pods

# deploy kibana
kubectl -n elastic-kibana apply -f .\kubernetes\elastic\kibana-demo.yaml
kubectl -n elastic-kibana get pods
```
